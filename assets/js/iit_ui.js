...
(function($) {
  ...
  $("#show-sample-images").on("click", function() {
    ...
    if (document.getElementById("show-sample-images").innerHTML.includes("Show")) {
      $("#show-sample-images").text("Hide sample images");
    } else {
      $("#show-sample-images").text("Show sample images");
    }
  });
